                    ...
                    <div class="card">
                        ...
                        <form method="POST" action="<?php echo base_url($this->uri->segment(1).'/editaction') ?>" class="form-horizontal" enctype="multipart/form-data">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <label class="col-md-2 col-form-label font-weight-bold">Rak</label>
                                    <div class="col-md-10">
                                      <div class="form-group">
                                          <input type="text" value="<?php echo $rak ?>" name="asal_surat" placeholder="Masukkan rak" class="form-control" required>
                                      </div>
                                    </div>
                                </div>
                                 <div class="row">
