...
INSERT INTO `tb_disposisi` (`id_disposisi`, `id_bagian`, `isi_disposisi`, `sifat`, `catatan`, `id_surat_masuk`, `tgl_disposisi`) VALUES
(20, 5, 'TINJAU KEMBALI', 'Segera', '-', 10, '2018-06-11'),
(21, 6, 'TINDAK LANJUTI', 'Penting', 'SECEPATNYA YA', 9, '2018-06-03'),
(22, 9, 'Kedatangan', 'Penting', 'Secepatnya', 7, '2018-06-03'),
(29, 5, 'Simpan saja', 'Rahasia', 'bertemu saya di meja saya jam 2 siang', 4, '2018-05-01'),
(30, 8, 'teliti lagi', 'Biasa', '-', 8, '2018-06-04'),
(31, 9, 'penting', 'Segera', 'secepatnya', 21, '2018-05-16'),
(32, 5, 'catat saja', 'Segera', '-', 20, '2018-06-06');
...
INSERT INTO `tb_notifikasi` (`id_notif`, `id_user`, `id`, `jenis_notif`, `judul_notif`, `isi_notif`, `status_notif`, `create_on`) VALUES
(3, 12, 30, 'disposisi', 'Disposisi Baru ', 'No. Surat 0098/00876 Isi Disposisi teliti lagi', 'y', '2018-06-07 00:46:48'),
(5, 10, 31, 'disposisi', 'Disposisi Baru ', 'No. Surat 800/729/313/2016 Isi Disposisi penting', 'y', '2018-06-07 01:08:22');
...
(535435, 1, 1, '5353535', 'SAMSUL', 'Laki - Laki', 'Jember', '1967-08-03', 'vdvd', 'vdvdv', 'Balung Kidul', '08125447444', 'SMA', '188.45/297/KTUN/021/2013', 'assets/uploads/foto_user/535435_2018-06-09 at 21:21:04.jpeg', '2018-05-29 09:36:41'),
...
(18, '800.V.58.V/135.V/201', 6, 'Petugas Penjaga Kantor Kelurahan', 'Melakukan tugas menjaga keamanan dan kebersamaan dan kebersihan Kantor Kelurahan ', 37, '-', '2018-02-02', '2018-06-06', 'Secepatnya', 'assets/uploads/file/Surat%20Tugas/Contoh-SURAT-PERINTAH-TUGAS-Keamanan.jpg', '');
...
(8, '0098/00876', 'Kantor Desa Taman Sari', 'Silaturahmi ', 4, '-', '2018-05-04', '2018-05-14', '-', 'y', 'assets/uploads/file/Surat%20Penduduk/piscok1.jpg', 'piscok1.jpg'),
...
(20, '470/8925/2016', 'Sekretariat Kabupaten', 'Pemberitahuan Masa Berlaku e-KTP', 31, 'KRT Elektronik (KTP-e) Berlaku', '2016-02-01', '2018-06-05', 'Terlampir', 'y', 'assets/uploads/file/Surat%20Pemberitahuan/insentif_dan_kualifikasi_s1_0001_(1).jpg', ''),
(21, '800/729/313/2016', 'Badan Kepegawaian', 'Pengangkatan CPNS menjadi PNS', 31, 'Pengangkatan CPNS menjadi PNS', '2016-03-21', '2018-06-05', 'Terlampir', 'y', 'assets/uploads/file/Surat%20Pemberitahuan/insentif_dan_kualifikasi_s1_0001.jpg', '');
...
INSERT INTO `tb_user` (`id_user`, `nip_user`, `username`, `password`, `level_user`, `token`) VALUES
(2, 2353257, 'ayu', 'dSvhkdHHAtpSQS+ynrMjypB1EiYTstzc+2H9+hWZfTwosJMeG7C8PgdzmeC6G+Jk2Qc7BqrNsC1T6u3rIWODFg==', 'admin', ''),
(3, 535435, 'samsul', '9PtdAviDaZoqeXbVNpMFunmRBWnpf2lnUJV4Dfv1SThp+V/KqrPUrl0WC+9oCfzLdwXSaOa9fNq3ww/O2aRCqw==', 'kepala desa', ''),
...
--
ALTER TABLE `tb_disposisi`
  MODIFY `id_disposisi` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;
--
...
--
ALTER TABLE `tb_jenis_surat`
  MODIFY `id_jenis_surat` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=38;
--
...
--
ALTER TABLE `tb_surat_masuk`
  MODIFY `id_surat_masuk` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
--
